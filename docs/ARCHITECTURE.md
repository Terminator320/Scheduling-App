...
`docs/plans/2026-08-29-calendar-holidays.md`. Nothing is dimmed, warned or
...
Run: `flutter test` (3025 passing as of 2026-08-29 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives fewer (2936), since some cases are
