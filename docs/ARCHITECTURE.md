...
Run: `flutter test` (2599 passing as of 2026-08-19 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives fewer, since some cases are generated
inside loops; `functions` adds 1327 jest tests across 56 suites in
