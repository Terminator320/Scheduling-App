...
Run: `flutter test` (2352 passing as of 2026-08-16 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives fewer, since some cases are generated
inside loops; `functions` adds 1274 jest tests across 52 suites in
