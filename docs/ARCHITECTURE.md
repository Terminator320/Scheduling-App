...
Run: `flutter test` (1649 passing as of 2026-08-08 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives 1605, since some cases are generated
inside loops; `functions` adds 819 jest
