...
Run: `flutter test` (2074 passing as of 2026-08-14 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives fewer, since some cases are generated
inside loops; `functions` adds 1112 jest tests across 47 suites in
