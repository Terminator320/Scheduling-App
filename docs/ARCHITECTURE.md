...
Run: `flutter test` (3058 passing as of 2026-09-01 — that is the runner's count;
`grep`ing for `test(`/`testWidgets(` gives fewer (2969), since some cases are
generated inside loops; `functions` adds 1636 jest tests across 75 suites in
