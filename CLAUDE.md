...
- **Editing an appointment must preserve assignees not in the active picker.**
  ...
  see the visit). Resolve the active set the way `_enrichSelectedEmployees` does
