    ...
    try {
      ...
      if (canAccessAdminMode) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => EmployeeCalendarDarkPage(
              employeeId: employeeId,
              employeeName: employeeName,
            ),
          ),
    ...
    return _AuthCardScaffold(
      ...
      onSecondaryTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => CreateAccountDarkScreen(),
          ),
        );
      },
      secondaryText: tr(context, 'Create account'),
...
class CreateAccountDarkScreen extends StatefulWidget {
  const CreateAccountDarkScreen({super.key});

  @override
  State<CreateAccountDarkScreen> createState() =>
      _CreateAccountDarkScreenState();
}

class _CreateAccountDarkScreenState extends State<CreateAccountDarkScreen> {
  final TextEditingController _emailController = TextEditingController();
  final TextEditingController _passwordController = TextEditingController();
