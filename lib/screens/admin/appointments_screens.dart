...
class _AdminAppointmentsPageState extends State<AdminAppointmentsPage> {
  ...
  List<AppointmentRecord> _filterAppointments(List<AppointmentRecord> appointments) {
    ...
    return appointments.where((appointment) {
      ...
      final clientPhone = appointment.clientPhone.toLowerCase();
      final employeeName = appointment.employeeName.toLowerCase();
                ...
                child: StreamBuilder<List<AppointmentRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (appointments.isEmpty) {
                      return Center(
                        child: Text(tr(context, 'No appointments found')),
                      );
                    }
...
class AdminAppointmentsDarkPage extends StatefulWidget {
  ...
  @override
  State<AdminAppointmentsDarkPage> createState() =>
      _AdminAppointmentsDarkPageState();
}
                ...
                child: StreamBuilder<List<AppointmentRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (appointments.isEmpty) {
                      return Center(
                        child: Text(
                          tr(context, 'No appointments found'),
                          style: TextStyle(color: Colors.white),
                        ),
                      );
                    }
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(
                      appointment.employeeName.trim().isEmpty
                          ? tr(context, 'No employee assigned')
...
Widget _appointmentInfoField({
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      hintText: hintText,
      suffixIcon:
          icon != null ? Icon(icon, size: 18, color: Colors.black45) : null,
      filled: true,
      fillColor: Colors.white,
...
Widget _appointmentInfoFieldDark({
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      suffixIcon:
          icon != null ? Icon(icon, size: 18, color: Colors.white54) : null,
      filled: true,
      fillColor: Color(0xFF171717),
      contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 14),
      enabledBorder: OutlineInputBorder(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 12),
                      _appointmentInfoField(
                        value: appointment.employeeName.trim().isEmpty
                            ? tr(context, 'No employee assigned')
                            : appointment.employeeName,
                        hintText: tr(context, 'Selected Employee'),
                      ),
                      SizedBox(height: 12),
                      _appointmentInfoField(
