...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,firstName,lastName,address,apt,city,province,country,postalCode,phone,mobile,email,const DeepCollectionEquality().hash(contacts),noFixedAddress,type,accessNotes,onSiteManager,billingTerms,autoInvoice,businessName,jobCount,createdAt,waveCustomerId,waveSyncState,waveSyncError]);

@override
String toString() {
  return 'ClientRecord(id: $id, name: $name, firstName: $firstName, lastName: $lastName, address: $address, apt: $apt, city: $city, province: $province, country: $country, postalCode: $postalCode, phone: $phone, mobile: $mobile, email: $email, contacts: $contacts, noFixedAddress: $noFixedAddress, type: $type, accessNotes: $accessNotes, onSiteManager: $onSiteManager, billingTerms: $billingTerms, autoInvoice: $autoInvoice, businessName: $businessName, jobCount: $jobCount, createdAt: $createdAt, waveCustomerId: $waveCustomerId, waveSyncState: $waveSyncState, waveSyncError: $waveSyncError)';
}
...
@useResult
$Res call({
 String id, String name, String firstName, String lastName, String address, String apt, String city, String province, String country, String postalCode, String phone, String mobile, String email, List<ClientContact> contacts, bool noFixedAddress, ClientType type, String accessNotes, String onSiteManager, String billingTerms, bool autoInvoice, String businessName, int? jobCount, DateTime? createdAt, String? waveCustomerId, String waveSyncState, String? waveSyncError
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String firstName,  String lastName,  String address,  String apt,  String city,  String province,  String country,  String postalCode,  String phone,  String mobile,  String email,  List<ClientContact> contacts,  bool noFixedAddress,  ClientType type,  String accessNotes,  String onSiteManager,  String billingTerms,  bool autoInvoice,  String businessName,  int? jobCount,  DateTime? createdAt,  String? waveCustomerId,  String waveSyncState,  String? waveSyncError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClientRecord() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String firstName,  String lastName,  String address,  String apt,  String city,  String province,  String country,  String postalCode,  String phone,  String mobile,  String email,  List<ClientContact> contacts,  bool noFixedAddress,  ClientType type,  String accessNotes,  String onSiteManager,  String billingTerms,  bool autoInvoice,  String businessName,  int? jobCount,  DateTime? createdAt,  String? waveCustomerId,  String waveSyncState,  String? waveSyncError)  $default,) {final _that = this;
switch (_that) {
case _ClientRecord():
return $default(_that.id,_that.name,_that.firstName,_that.lastName,_that.address,_that.apt,_that.city,_that.province,_that.country,_that.postalCode,_that.phone,_that.mobile,_that.email,_that.contacts,_that.noFixedAddress,_that.type,_that.accessNotes,_that.onSiteManager,_that.billingTerms,_that.autoInvoice,_that.businessName,_that.jobCount,_that.createdAt,_that.waveCustomerId,_that.waveSyncState,_that.waveSyncError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String firstName,  String lastName,  String address,  String apt,  String city,  String province,  String country,  String postalCode,  String phone,  String mobile,  String email,  List<ClientContact> contacts,  bool noFixedAddress,  ClientType type,  String accessNotes,  String onSiteManager,  String billingTerms,  bool autoInvoice,  String businessName,  int? jobCount,  DateTime? createdAt,  String? waveCustomerId,  String waveSyncState,  String? waveSyncError)?  $default,) {final _that = this;
switch (_that) {
case _ClientRecord() when $default != null:
return $default(_that.id,_that.name,_that.firstName,_that.lastName,_that.address,_that.apt,_that.city,_that.province,_that.country,_that.postalCode,_that.phone,_that.mobile,_that.email,_that.contacts,_that.noFixedAddress,_that.type,_that.accessNotes,_that.onSiteManager,_that.billingTerms,_that.autoInvoice,_that.businessName,_that.jobCount,_that.createdAt,_that.waveCustomerId,_that.waveSyncState,_that.waveSyncError);case _:
  return null;
...
class _ClientRecord extends ClientRecord {
  const _ClientRecord({required this.id, this.name = '', this.firstName = '', this.lastName = '', this.address = '', this.apt = '', this.city = '', this.province = '', this.country = '', this.postalCode = '', this.phone = '', this.mobile = '', this.email = '', final  List<ClientContact> contacts = const <ClientContact>[], this.noFixedAddress = false, this.type = ClientType.unset, this.accessNotes = '', this.onSiteManager = '', this.billingTerms = '', this.autoInvoice = false, this.businessName = '', this.jobCount = null, this.createdAt, this.waveCustomerId = null, this.waveSyncState = '', this.waveSyncError = null}): _contacts = contacts,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,name,firstName,lastName,address,apt,city,province,country,postalCode,phone,mobile,email,const DeepCollectionEquality().hash(_contacts),noFixedAddress,type,accessNotes,onSiteManager,billingTerms,autoInvoice,businessName,jobCount,createdAt,waveCustomerId,waveSyncState,waveSyncError]);
