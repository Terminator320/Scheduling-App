...
mixin _$AppointmentRecord {
 ...
 DateTime get startTime; DateTime get endTime; String? get id; String get title; String get clientId; String get clientName; String get clientPhone; List<String> get employeeIds; List<String> get employeeNames; String get address; String get notes; String get materialsNeeded; String get status; RepeatInterval get repeat;// Links the occurrences of one repeat series (the first visit's doc id).
...
@override
int get hashCode => Object.hash(runtimeType,startTime,endTime,id,title,clientId,clientName,clientPhone,const DeepCollectionEquality().hash(employeeIds),const DeepCollectionEquality().hash(employeeNames),address,notes,materialsNeeded,status,repeat,seriesId,createdAt,updatedAt,const DeepCollectionEquality().hash(pictures));

@override
String toString() {
  return 'AppointmentRecord(startTime: $startTime, endTime: $endTime, id: $id, title: $title, clientId: $clientId, clientName: $clientName, clientPhone: $clientPhone, employeeIds: $employeeIds, employeeNames: $employeeNames, address: $address, notes: $notes, materialsNeeded: $materialsNeeded, status: $status, repeat: $repeat, seriesId: $seriesId, createdAt: $createdAt, updatedAt: $updatedAt, pictures: $pictures)';
}
...
@useResult
$Res call({
 DateTime startTime, DateTime endTime, String? id, String title, String clientId, String clientName, String clientPhone, List<String> employeeIds, List<String> employeeNames, String address, String notes, String materialsNeeded, String status, RepeatInterval repeat, String seriesId, DateTime? createdAt, DateTime? updatedAt, List<AppointmentImage> pictures
});
...
switch (_that) {
case _AppointmentRecord() when $default != null:
return $default(_that.startTime,_that.endTime,_that.id,_that.title,_that.clientId,_that.clientName,_that.clientPhone,_that.employeeIds,_that.employeeNames,_that.address,_that.notes,_that.materialsNeeded,_that.status,_that.repeat,_that.seriesId,_that.createdAt,_that.updatedAt,_that.pictures);case _:
  return orElse();
...
class _AppointmentRecord extends AppointmentRecord {
  const _AppointmentRecord({required this.startTime, required this.endTime, this.id, this.title = '', this.clientId = '', this.clientName = '', this.clientPhone = '', final  List<String> employeeIds = const <String>[], final  List<String> employeeNames = const <String>[], this.address = '', this.notes = '', this.materialsNeeded = '', this.status = 'pending', this.repeat = RepeatInterval.none, this.seriesId = '', this.createdAt, this.updatedAt, final  List<AppointmentImage> pictures = const <AppointmentImage>[]}): _employeeIds = employeeIds,_employeeNames = employeeNames,_pictures = pictures,super._();
...
@override
int get hashCode => Object.hash(runtimeType,startTime,endTime,id,title,clientId,clientName,clientPhone,const DeepCollectionEquality().hash(_employeeIds),const DeepCollectionEquality().hash(_employeeNames),address,notes,materialsNeeded,status,repeat,seriesId,createdAt,updatedAt,const DeepCollectionEquality().hash(_pictures));
