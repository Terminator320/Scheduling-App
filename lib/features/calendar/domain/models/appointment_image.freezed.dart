...
bool operator ==(Object other) {
  final _this = this as AppointmentImage;
...
int get hashCode {
  final _this = this as AppointmentImage;
  return Object.hash(runtimeType,_this.url,_this.storagePath,_this.fileName,_this.uploadedAt);
}

@override
String toString() {
  final _this = this as AppointmentImage;
  return 'AppointmentImage(url: ${_this.url}, storagePath: ${_this.storagePath}, fileName: ${_this.fileName}, uploadedAt: ${_this.uploadedAt})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,url,storagePath,fileName,uploadedAt);
}
