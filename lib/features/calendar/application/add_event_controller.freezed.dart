...
switch (_that) {
case _AddEventState() when $default != null:
return $default(_that.selectedDate,_that.selectedStartTime,_that.selectedEndTime,_that.endTimeWasPickedManually,_that.selectedClient,_that.clientResults,_that.isSearchingClient,_that.useCustomAddress,_that.isPersonal,_that.isAllDay,_that.selectedEmployees,_that.repeat,_that.selectedImages,_that.isSubmitting,_that.errors);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,selectedDate,selectedStartTime,selectedEndTime,endTimeWasPickedManually,selectedClient,const DeepCollectionEquality().hash(_clientResults),isSearchingClient,useCustomAddress,isPersonal,isAllDay,const DeepCollectionEquality().hash(_selectedEmployees),repeat,const DeepCollectionEquality().hash(_selectedImages),isSubmitting,const DeepCollectionEquality().hash(_errors));
