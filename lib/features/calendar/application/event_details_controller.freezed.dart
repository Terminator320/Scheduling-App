...
mixin _$EventDetailsState {
 ...
 DateTime get selectedDate; TimeOfDay get selectedStartTime; TimeOfDay get selectedEndTime; String get editingStatus; bool get isEditing; RepeatInterval get repeat;// The repeat value as last saved — if the user changes it, that triggers new bookings.
