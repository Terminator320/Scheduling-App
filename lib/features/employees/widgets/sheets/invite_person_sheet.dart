...
class _InvitePersonSheetState extends ConsumerState<InvitePersonSheet> {
  ...
  Future<void> _save() async {
    ...
    final nextErrors = EmployeeFormValidator.validate(
      l10n: context.l10n,
      name: _firstNameController.text.trim().isEmpty ? '' : composedName,
...
/// does not work until the person redeems the code, which is a caveat, not a
/// success.
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              context.l10n.employees_invitedNote,
